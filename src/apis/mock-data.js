    ...
    columns: [
      {
        ...
        cardOrderIds: ['card-id-04', 'card-id-03', 'card-id-02', 'card-id-01', 'card-id-05', 'card-id-06', 'card-id-07'],
        cards: [
          {
            _id: 'card-id-01',
            boardId: 'board-id-01',
            ...
            cover: 'https://cdn.mos.cms.futurecdn.net/6AxBGxrtbSAkmhLmtdvGLX.jpg',
